...
function renderClientes() {
  ...
  const summary = document.getElementById("clienteMSSummary");
  if (!box || !panel || !root) return;
  ...
  function updateSummary(){
    ...
    if (summary) summary.textContent = `${checked.length} seleccionados`;
  }

  // "Todos": al tildarlo, destilda el resto y aplica
  ...
  // Cuando elijo uno o varios, saco "Todos" y aplico
