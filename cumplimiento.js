          ...
          data: (() => {
            ...
            for (let i = 1; i < months.length; i++) {
              ...
              if (val !== currentVal) {
                ...
                // Usamos +/- 0.49 para evitar clipping en bordes
                segments.push([
                  { coord: [startIdx - 0.49, currentVal], value: currentVal },
                  { coord: [i - 1 + 0.49, currentVal] }
                ]);
            ...
            // Último segmento: Forzamos etiqueta a la derecha para que no tape
            segments.push([
              {
                coord: [startIdx - 0.49, currentVal],
                value: currentVal,
