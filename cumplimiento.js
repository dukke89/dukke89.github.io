...

      {
        ...
        markLine: {
          ...
          data: (() => {
            ...
            console.log("=== COMBINED MARKLINE DEBUG ===");
            ...
            // SEGMENTO 1: Línea del 75% (gris punteado)
            if (changeIndex === -1) {
              // Si no hay cambio, línea completa del 75%
              allSegments.push({
                yAxis: 75,
                value: 75,
                label: {
              ...
              // Línea del 75% hasta antes del cambio
              allSegments.push([
                {
                  coord: [-0.5, 75],
                  value: 75,
            ...
            // SEGMENTO 2: Línea del 78% (índigo sólido) - SOLO MESES 2026
            if (changeIndex !== -1) {
              console.log("78% line starting at index:", changeIndex);

              // Usar coord para abarcar el ancho completo de las columnas 2026
              allSegments.push([
                {
                ...
                },
                {
                  ...
                  label: {
                    ...
                    fontSize: 11,
                    position: "end",
                    offset: [10, 0],  // Separar la etiqueta de la columna
            ...
            console.log("Combined segments:", JSON.stringify(allSegments));
            return allSegments;
          })(),
          z: 100,
          zlevel: 10
