...

      {
        ...
        markLine: {
          ...
          data: (() => {
            ...
            if (changeIndex !== -1) {
              // Encontrar el primer y último mes de 2026
              const firstMonth2026 = months[changeIndex];
              const lastMonth2026 = months[months.length - 1];

              console.log("78% line from", firstMonth2026, "to", lastMonth2026);

              allSegments.push([
                {
                  xAxis: firstMonth2026,
                  yAxis: 78,
                  value: 78,
