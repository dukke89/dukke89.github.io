    ...
    if (isLast75) {
      return {
        ...
        label: {
          show: true,
          position: "left",
          offset: [-10, 0], // Forzar desplazamiento a la izquierda
          formatter: "Obj 75%",
  ...
  const option = {
    ...
    series: [
      ...
      },
      {
        ...
        // IMPORTANTISIMO: MarkLine usando xAxis/yAxis para mayor compatibilidad
        markLine: {
          silent: true,
          symbol: ["none", "none"],
          animation: false, // Evitar problemas de animación
          data: [
            [
              {
                xAxis: idx2026 - 0.5,
