...

      {
        ...
        markLine: {
          ...
          data: (() => {
            ...
            console.log("=== MARKLINE DEBUG ===");
            console.log("Months:", months);

            const segments = [];

            // Encontrar el índice donde cambia de 75% a 78%
            let changeIndex = -1;
            for (let i = 0; i < months.length; i++) {
              const goal = getGoalForMonth(months[i]);
              console.log(`Month ${months[i]}: goal = ${goal}`);
            ...
            console.log("Change index (where 78% starts):", changeIndex);

            // Si todos los meses son 75%, una sola línea
            if (changeIndex === -1) {
              segments.push({ yAxis: 75, value: 75 });
            } else {
              // Línea del 75% (desde inicio hasta el último mes de 75%)
              if (changeIndex > 0) {
                segments.push([
              ...
              // Línea del 78% - ABARCA TODO EL ANCHO DE ENERO 2026
              segments.push([
                {
                ...
                {
                  coord: [changeIndex + 0.5, 78],  // Termina al final de enero 2026
                  label: {
                    show: true,
                    position: "end",
                    formatter: "Obj 78%"
            ...
            console.log("Generated segments:", JSON.stringify(segments));
            return segments;
          })(),
          z: 100,
          zlevel: 10
