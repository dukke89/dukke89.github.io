...
/* ============================
   CONFIG
============================ */
const CSV_FILE = "CUMPLIMIENTO_2025.csv";
  // nombre EXACTO en tu repo
const DELIM = ";";
...
function bindChartsResize(){
  ...
  bindChartsResize();
    ...
    try { chartTendencia && chartTendencia.resize(); } catch(e) {}
  }, { passive: true });
}
...
function showError(msg) {
  setHTML("msg", `<div class="error">${msg}

function clearMsg(){
  setHTML("msg", "");
}
function showInfo(msg){
  setHTML("msg", `<div class="notice">${msg}</div>`);
}
function showLoading(msg="Cargando datos…"){
  setHTML("msg", `<div class="notice loading"><span class="spinner"></span><span>${msg}</span></div>`);
}
