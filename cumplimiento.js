          ...
          data: (() => {
            ...
            for (let i = 1; i < months.length; i++) {
              ...
              if (val !== currentVal) {
                ...
                segments.push([
                  { coord: [startIdx - 0.5, currentVal], value: currentVal },
                  { coord: [i - 1 + 0.5, currentVal] }
                ]);
            ...
            segments.push([
              {
                coord: [startIdx - 0.5, currentVal],
                value: currentVal,
                // Estilo en el punto de inicio para que aplique a la línea
                lineStyle: {
                  color: "#4f46e5", // Indigo vibrante
                  type: "solid",
                  width: 3
                }
              },
              {
                coord: [months.length - 1 + 0.5, currentVal],
                label: {
                  show: true,
                  position: "end",
                  // Sin offset, alinear con 'Lím 7 d'
                  formatter: "Obj {c}%"
                }
              }
            ]);
