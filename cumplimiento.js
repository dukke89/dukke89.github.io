...
// URLs candidatas (GitHub Pages a veces cambia el "base path" según cómo navegás)
const CSV_URLS = [
  csvUrl,
  "./" + csvUrl,
  "/" + csvUrl,
...
// fetch robusto: prueba varias rutas hasta encontrar la que responda OK
async function fetchTextAny(urls) {
  ...
  throw lastErr || new Error("No se pudo cargar CSV");
}
