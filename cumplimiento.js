...
function buildChartMes(rows) {
  ...
  const tDem = {
    ...
    line: { color: "#1d4ed8", width: 3 }, // azul
  ...
  const layout = {
    ...
    font: { family: "Source Sans 3, system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif", size: 12, color: "#0E1A2B" },
    uniformtext: { mode: "hide", minsize: 10 },
    bargap: 0.18,
    hovermode: "x unified",
    legend: { orientation: "h", y: -0.22, x: 0, xanchor: "left" },
    margin: { l: 50, r: 60, t: 20, b: 55 },
